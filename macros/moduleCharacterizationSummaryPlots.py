...
# INPUT
inputdir = '/afs/cern.ch/user/s/spalluot/MTD/TB_FNAL_Mar23/Lab5015Analysis/plots/'
source = 'TB'


# OUTPUT
outdir  = '/eos/home-s/spalluot/www/MTD/MTDTB_FNAL_Mar23/ModuleCharacterization/'
...
#     plots_label = 'HPK (25 #mum) + LYSO818 (prod1, type1)'
#     for vov in Vovs:
#         VovsEff[vov] = vov 
#     goodBars[3.50] = [0,2,3,4,5,7,8,9,10,11,12,13] 
#     goodBars[1.50] = [0,2,3,4,5,7,8,9,10,11,12,13]
